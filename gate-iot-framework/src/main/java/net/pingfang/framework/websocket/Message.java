...
public interface Message {
	...
	static Message error(String id, String topic, Throwable message) {
		...
		return new SimpleMessage(id, topic, null, Type.error,
				message.getMessage() == null ? message.getClass().getSimpleName() : message.getMessage());
	}
	...
	enum Type {
		authError, result, error, complete, ping, pong
	}
}
