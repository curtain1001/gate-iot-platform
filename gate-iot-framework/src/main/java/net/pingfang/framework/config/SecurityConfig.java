...
import net.pingfang.framework.config.properties.PermitAllUrlProperties;
import net.pingfang.framework.security.filter.JwtAuthenticationTokenFilter;
import net.pingfang.framework.security.handle.AuthenticationEntryPointImpl;
import net.pingfang.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity
				...
				.antMatchers("/login", "/register", "/captchaImage", "/websocket/message").anonymous()
				// 静态资源，可匿名访问
				.antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/profile/**")
				.permitAll()
				.antMatchers("ws/**", "/swagger-ui.html", "/swagger-resources/**", "/webjars/**", "/*/api-docs",
						"/druid/**")
				.permitAll()
				// 除上面外的所有请求全部需要鉴权认证
