 ...
 */
@Getter
public enum TcpClientBasicForm implements Customized {
	IP("host", "string", "", "ip地址", "", ""), //
	PORT("port", "number", "", "端口号", "", ""), //
	PARSER_TYPE("parserType", "customized", parserTypeOptions(), "解析方式", "", ""), //
	;

	TcpClientBasicForm(String value, String type, String options, String label, String customizeType, Object defaults) {
		this.value = value;
		this.type = type;
		// 对options进行赋值
