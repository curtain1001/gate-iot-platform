...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
	...
	public void drawConnection(int[] xPoints, int[] yPoints, boolean conditional, boolean isDefault,
		...
		for (int i = 1; i < xPoints.length; ++i) {
			...
			java.awt.geom.Line2D.Double line = new java.awt.geom.Line2D.Double((double) sourceX, (double) sourceY,
	...
	public void initialize(String imageType) {
		...
		try {
			...
			MULE_TASK_IMAGE = ImageIO
					.read(ReflectUtil.getResource("org/flowable/icons/muleTask.png", this.customClassLoader));
	...
	protected void drawTask(String name, GraphicInfo graphicInfo, boolean thickBorder, double scaleFactor) {
		...
		// Create a new gradient paint for every task box, gradient depends on x and y
		// and is not relative
